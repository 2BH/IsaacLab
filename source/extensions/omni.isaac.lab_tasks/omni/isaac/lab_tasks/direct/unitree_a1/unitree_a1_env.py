...
@configclass
class UnitreeA1FlatRoughEnvCfg(UnitreeA1FlatEnvCfg):
    # env
...
class UnitreeA1Env(DirectRLEnv):
    cfg: UnitreeA1FlatEnvCfg | UnitreeA1RoughEnvCfg | UnitreeA1FlatRoughEnvCfg

    def __init__(self, cfg: UnitreeA1FlatEnvCfg | UnitreeA1FlatRoughEnvCfg | UnitreeA1RoughEnvCfg, render_mode: str | None = None, **kwargs):
        ...
        self._underisred_contact_body_ids, _ = self._contact_sensor.find_bodies(".*_thigh")
    ...
    def _setup_scene(self):
        ...
        # add lights
        light_cfg = sim_utils.DomeLightCfg(intensity=750.0, color=(0.75, 0.75, 0.75), texture_file=f"{ISAAC_NUCLEUS_DIR}/Materials/Textures/Skies/PolyHaven/kloofendal_43d_clear_puresky_4k.hdr")
