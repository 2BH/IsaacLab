...
class EventCfg:
    ...
    reset_robot_wrist_joint = EventTerm(
        ...
        mode="reset",
        params={
            "asset_cfg": SceneEntityCfg("robot", joint_names="xarm_joint_7"),
            "position_range": [-3, 3],
            "velocity_range": [0.0, 0.0],
        },
    )
...
@configclass
class DexgraspReorientEnvCfg(ManagerBasedEnvCfg):
...
class DexgraspLiftEnvCfg(DexgraspReorientEnvCfg):
...
class DexgraspReorientEnvCfg_PLAY(DexgraspReorientEnvCfg):
    """Dexgrasp reorientation task evaluation environment definition"""
...
class DexgraspLiftEnvCfg_PLAY(DexgraspLiftEnvCfg):
